...
function building_listening_block() {
	...
	for (var i = 0; i < listening_array.length; i++) {
		...
		build_string += "<div class=\"col-250-at-widescreen col-100p-at-smallscreen vietnamese font-size-10pt-at-smallscreen font-size-18pt-at-widescreen\">" + speech[3] + "</div>";
		build_string += "</div>";
	}
